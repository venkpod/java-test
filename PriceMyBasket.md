...
## Delivery
Please supply all your code, with instructions on how to build the solution and its executable artefacts to be submitted 24 hours before the review.
 - Please _fork_ this repository and give access to the review team, _details below_:
   - [Mark](https://github.com/markgaywood), GIT hub account: _markgaywood_
   - [Mischa](https://github.com/mischa-geldermans), GIT hub account: _mischa-geldermans_

## Review
We will set up a meeting in the style of a code review. 

Prepare any views/opinions of any enhancements that you feel would improve the solution you have provided to Henry’s Grocery.
